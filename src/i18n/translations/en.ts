...
const en: Translations = {
	...
	js: {
		...
		safeToBunkPrefix: 'Safe to Bunk: {n} classes',
		bunkBufferZero: 'Bunk Buffer: 0 classes',
		safeDescWithBunks: 'You can miss the next {n} classes in a row without dropping below {target}%.',
		...
		attendNextPrefix: 'Attend Next: {n} classes',
		attendNextDesc: 'Attend {n} consecutive classes without missing to climb back to {target}%.',
		cookedHeadline: '💀 Term Outlook: Cooked',
		cookedDesc: 'Even with 100% attendance in all {remaining} remaining classes, max achievable is only {maxPct}%.',
		semBudgetHeadline: 'Semester Bunk Budget: {n} classes',
		semBudgetDesc: 'Out of {remaining} remaining classes, you only need to attend {needed} to finish above {target}%.',
		mustAttendHeadline: 'Must Attend: {needed} / {remaining} classes',
		mustAttendDesc: 'You must attend at least {needed} of the {remaining} remaining classes to hit {target}%.',
		...
		vibeSafeWithBunksHtml:
			"You're safe to bunk! Go touch grass, grab some chai, and enjoy your free time. <strong>{n} safe bunks available.</strong> 🚀",
		vibeSafeOnEdgeHtml:
		...
		vibeBorderlineMessageHtml:
			'Walking on thin ice bro. <strong>Time to wake up and head to class!</strong> Attend the next <strong>{n} classes</strong> to fix this. ☕',
		vibeShortageStatus: 'Shortage 🚨',
		vibeShortageMessageHtml:
			'Time to wake up and head to class. <strong>You can still fix this if you grind now!</strong> Attend the next <strong>{n} classes</strong> consecutively. 📚',
