...
const de: Translations = {
	...
	js: {
		...
		safeToBunkPrefix: 'Sicher zu schwänzen: {n} Stunden',
		...
		attendNextPrefix: 'Als Nächstes besuchen: {n} Stunden',
		attendNextDesc: 'Besuche {n} Stunden am Stück ohne Fehlzeit, um wieder auf {target}% zu kommen.',
		...
		semBudgetHeadline: 'Semester-Fehlstunden-Budget: {n} Stunden',
		...
		vibeSafeWithBunksHtml:
			'Du kannst gefahrlos schwänzen! Geh raus, hol dir einen Chai und genieß deine Freizeit. <strong>{n} sichere Fehlstunden verfügbar.</strong> 🚀',
		vibeSafeOnEdgeHtml:
