...
const it: Translations = {
	...
	js: {
		...
		safeToBunkPrefix: 'Puoi Saltare: {n} lezioni',
		...
		attendNextPrefix: 'Frequenta le Prossime: {n} lezioni',
		...
		semBudgetHeadline: 'Margine Assenze Semestre: {n} lezioni',
		...
		vibeSafeWithBunksHtml:
			"Puoi saltare senza problemi! Vai a prenderti una boccata d'aria, un caffè, e goditi il tempo libero. <strong>{n} assenze sicure disponibili.</strong> 🚀",
		vibeSafeOnEdgeHtml:
