...
const es: Translations = {
	...
	js: {
		...
		safeToBunkPrefix: 'Puedes Faltar: {n} clases',
		...
		attendNextPrefix: 'Debes Asistir a: {n} clases',
		...
		semBudgetHeadline: 'Margen de Faltas del Semestre: {n} clases',
		...
		vibeSafeWithBunksHtml:
			"¡Puedes faltar sin problema! Sal a tomar aire, tómate un café y disfruta tu tiempo libre. <strong>{n} faltas disponibles sin riesgo.</strong> 🚀",
		vibeSafeOnEdgeHtml:
