...
const pt: Translations = {
	...
	results: {
		...
		shareButtonText: 'Compartilhar Resultado',
		shareCopiedText: 'Imagem baixada e legenda copiada!',
		shareStatAttendedLabel: 'FREQUÊNCIA',
		shareStatTargetLabel: 'META',
	},
	js: {
		...
		safeToBunkPrefix: 'Pode Faltar: {n} {classWord}',
		...
		attendNextPrefix: 'Frequentar: {n} {classWord}',
		...
		semBudgetHeadline: 'Margem de Faltas do Semestre: {n} {classWord}',
		...
		vibeSafeWithBunksHtml:
			"Você pode faltar sem medo! Vá tomar um ar, tomar um café e aproveitar o seu tempo livre. <strong>{n} {bunkWord} sem risco.</strong> 🚀",
		vibeSafeOnEdgeHtml:
		...
		bunkSingular: 'falta',
		bunkPlural: 'faltas',
		semTotalErrorTooLow: 'O total do semestre não pode ser menor que as aulas já realizadas ({held}).',
		semTotalErrorNonPositive: 'Digite um número positivo.',
		semTotalErrorTooLarge: 'Digite um número não maior que {max}.',
		semesterLineBudget: '{remainVerb} {n} {bunkWord} de {remaining} {classWordRemaining}',
		semesterLineMustAttend: 'precisa frequentar {needed} de {remaining} {classWordRemaining}',
		semesterLineCooked: 'ferrado: máximo {maxPct}% mesmo indo a tudo',
		safeToBunkCappedPrefix: 'Pode Faltar: {n} {classWord} ({cappedVerb} apenas {n} neste semestre)',
		remainVerbSingular: 'resta',
		remainVerbPlural: 'restam',
		semCompleteHeadline: '🏁 Semestre Concluído: {pct}%',
		semCompleteMetDesc: 'Você terminou o semestre com {pct}%, atingindo sua meta de {target}%. 🎉',
		semCompleteMissedDesc: 'Você terminou o semestre com {pct}%, abaixo da sua meta de {target}%.',
		semesterLineCompleteMet: 'semestre concluído com {pct}% — meta atingida 🎉',
		semesterLineCompleteMissed: 'semestre concluído com {pct}% — meta não atingida',
		customTargetError: 'Digite um valor entre 1 e 100.',
		vibeCompleteStatus: 'Semestre Concluído 🏁',
